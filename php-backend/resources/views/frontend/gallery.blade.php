...
<html lang="en">
  <head>
    ...
    <title>Himalayan Blossom Gallery — Valleys, Harvests &amp; Events</title>
    <meta
      name="description"
      ...
      >
        ...
        <nav id="navmenu" class="navmenu d-none d-xl-block">
          <ul class="d-flex align-items-center mb-0">
            ...
            <li>
              <a href="gallery.html" class="active" data-en="Gallery" data-hi="गैलरी"
                >Gallery</a
              >
            </li>
            <li>
    ...
    <main class="main">
        ...
        <div class="container">
          <div class="row gy-4 align-items-center">
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              <span class="badge text-bg-light px-3 py-2 mb-3" data-en="Visual Journey" data-hi="दृश्य यात्रा">Visual Journey</span>
              <h1 class="display-5 mb-3" data-en="Travel Through Himalayan Blossom" data-hi="हिमालयन ब्लॉसम की यात्रा करें">
                Travel Through Himalayan Blossom
              </h1>
              <p class="lead" data-en="From bloom-drenched valleys to moonlit harvest nights, explore the people and places behind each jar." data-hi="फूलों से भरी घाटियों से लेकर चांदनी फसल की रातों तक, हर जार के पीछे के लोग और स्थानों को खोजें।">
                From bloom-drenched valleys to moonlit harvest nights, explore the people and places behind each jar.
              </p>
              <div class="d-flex flex-wrap gap-3">
                <a href="about.html" class="btn-get-started" data-en="Meet the Beekeepers" data-hi="मधुमक्खी पालकों से मिलें">
                  Meet the Beekeepers
                </a>
                <a href="preorder.html" class="btn btn-outline-primary px-4" data-en="Reserve Your Jar" data-hi="अपना जार आरक्षित करें">
                  Reserve Your Jar
                </a>
              </div>
            </div>
            <div class="col-lg-6" data-aos="zoom-out" data-aos-delay="200">
              <div class="ratio ratio-16x9 rounded-4 overflow-hidden shadow-lg">
                <img
                  ...
                  alt="Moonlit honey harvest preparation"
                />
              </div>
            </div>
          </div>
      ...
      <section id="gallery" class="gallery section light-background">
        ...
        <div class="container section-title" data-aos="fade-up">
          ...
          <p>
            <span>Explore</span>
            <span class="description-title">Our Valleys & Harvests</span>
          </p>
        </div>
        <!-- End Section Title -->
              ...
              <div class="swiper-slide">
                <a
                  ...
                  ><img
                    ...
                    class="img-fluid"
                    alt="Apiary in Himalayan meadows"
                /></a>
              </div>
              <div class="swiper-slide">
                <a
              ...
              <div class="swiper-slide">
                <a
                  ...
                  ><img
                    ...
                    class="img-fluid"
                    alt="Traceable small-batch honey"
                /></a>
              </div>
              <div class="swiper-slide">
                <a
              ...
              <div class="swiper-slide">
                <a
                  ...
                  ><img
                    ...
                    class="img-fluid"
                    alt="Himalayan sunset over hives"
                /></a>
              </div>
            </div>
            <div class="swiper-pagination"></div>
