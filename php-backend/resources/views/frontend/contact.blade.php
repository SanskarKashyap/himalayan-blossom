...
<html lang="en">
  <head>
    ...
    <title>Contact Himalayan Blossom — Connect &amp; Visit</title>
    <meta
      name="description"
      ...
      >
        ...
        <nav id="navmenu" class="navmenu d-none d-xl-block">
          <ul class="d-flex align-items-center mb-0">
            ...
            <li>
              <a href="contact.html" class="active" data-en="Contact" data-hi="संपर्क"
                >Contact</a
              >
            </li>
          </ul>
    ...
    <main class="main">
        ...
        <div class="container">
          <div class="row gy-4 align-items-center">
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              <span class="badge text-bg-light px-3 py-2 mb-3" data-en="Connect" data-hi="संपर्क">Connect</span>
              <h1 class="display-5 mb-3" data-en="We'd Love to Hear From You" data-hi="हम आपसे सुनना चाहेंगे">
                We'd Love to Hear From You
              </h1>
              <p class="lead" data-en="Reach out for pre-orders, partnerships, or to plan a tasting at our Himalayan studio." data-hi="प्री-ऑर्डर, साझेदारी या हमारे हिमालयी स्टूडियो में टेस्टिंग की योजना के लिए हमसे संपर्क करें।">
                Reach out for pre-orders, partnerships, or to plan a tasting at our Himalayan studio.
              </p>
              <div class="d-flex flex-wrap gap-3">
                <a href="preorder.html" class="btn-get-started" data-en="Reserve a Jar" data-hi="एक जार आरक्षित करें">
                  Reserve a Jar
                </a>
                <a href="mailto:hello@himalayanblossom.com" class="btn btn-outline-primary px-4" data-en="Email Us" data-hi="हमें ईमेल करें">
                  Email Us
                </a>
              </div>
            </div>
            <div class="col-lg-6" data-aos="zoom-out" data-aos-delay="200">
              <div class="ratio ratio-4x3 rounded-4 overflow-hidden shadow-lg">
                <img
                  ...
                  alt="Himalayan Blossom tasting room"
                />
              </div>
            </div>
          </div>
      ...
      <section id="contact" class="contact section">
        ...
        <div class="container section-title">
          ...
          <p>
            <span data-en="Need Help?" data-hi="मदद चाहिए?">Need Help?</span>
            <span
              class="description-title"
              data-en="Contact Us"
              data-hi="हमसे संपर्क करें"
              >Contact Us</span
            >
          </p>
        </div>
        ...
        <div class="container">
          <div class="mb-5 map-container">
            <div class="map-placeholder" onclick="loadMap()">
          ...
          <div class="row gy-4">
            <div class="col-md-6">
              <div class="info-item d-flex align-items-center">
                ...
                <div>
                  ...
                  <p>
                    Sample Valley Apiaries, Kullu District, Himachal Pradesh,
                    India
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="info-item d-flex align-items-center">
                ...
                <div>
                  <h3 data-en="Call Us" data-hi="हमें कॉल करें">Call Us</h3>
                  <p>+91 98765 43210</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="info-item d-flex align-items-center">
                ...
                <div>
                  <h3 data-en="Email Us" data-hi="हमें ईमेल करें">Email Us</h3>
                  <p>hello@himalayanblossom.com</p>
                </div>
              </div>
            </div>
            <!-- End Info Item -->
            ...
            <div class="col-md-6">
              <div class="info-item d-flex align-items-center">
                ...
                <div>
                  <h3 data-en="Opening Hours" data-hi="खुलने का समय">
                    Opening Hours
                  </h3>
                  <p>
                    <strong>Mon-Sat:</strong> 09:00 - 18:00;
